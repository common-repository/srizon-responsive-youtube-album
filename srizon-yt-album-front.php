...
function srz_yt_enqueue_script() {
    ...
    wp_enqueue_script( 'srzcustom', srz_yt_get_resource_url( 'js/srizon.custom.min.js' ), array( 'jquery' ),'3.5.0' );
    ...
    wp_enqueue_style( 'srzcustomcss', srz_yt_get_resource_url('css/srizon.custom.min.css'),null,'3.5.0');
}
